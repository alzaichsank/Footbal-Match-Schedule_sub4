    ...
    override fun parsingData(context: Activity, response: String): ArrayList<EventsItem> {
        ...
        try {
            ...
            for (i in 0 until message.length()) {
                ...
                listData.add(EventsItem(i.toLong(), idEvent, dateEvent, strSport, idHome, nameHome, scoreHome, formationHome, golDetailHome, intShotHome, lineupgkHome, lineupdefHome, lineupmidhome, lineupforwadHome, lineupsubHome,
